...
/**
 * Clase que define al Dittu Chapulin e
 * implementa la interfaz TipoDittu para poder ser intercambiable
 * en la clase Dittu despues.
 */
public class DittuChapulin implements TipoDittu {

	/* Informacion del personaje */
	private String nombre = "Dittu Chapulin";
	private String transformacion = "Dittu copia a un joven que estaba ligando con la ex de su amigo."
			+ "\nDittu ahora tiene la forma de un chapulin.";
	private int vida = 21;
	private int golpe = 1;
	private int patada = 5;
	private int bloqueo = 1;
	private String especial = "Dittu chapulinea a un amigo suyo: "
			+ "\n* patada + 1.5 \n* honor - 5";
