...
/**
 * Clase que define al Dittu Tlacuache e
 * implementa la interfaz TipoDittu para poder ser intercambiable
 * en la clase Dittu despues.
 */
public class DittuTlacuache implements TipoDittu {

	/* Informacion del personaje */
	private String nombre = "Dittu Tlacuache";
	private String transformacion = "Dittu copia a un tlacuachito que ve pasar."
			+ "\nDittu ahora parece un tlacuache.";
	private int vida = 21;
	private int golpe = 2;
	private int patada = 3;
	private int bloqueo = 4;
	private String especial = "Dittu se encuentra un poco de rica basura: "
			+ "\n* golpe + 0.5 \n* patada + 0.5 \n* bloqueo + 2";
