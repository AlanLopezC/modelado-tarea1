...
/**
 * Clase que define al Korby Fresa e
 * implementa la interfaz TipoKorby para poder ser intercambiable
 * en la clase Korby despues.
 */
public class KorbyFresa implements TipoKorby {

	/* Informacion del personaje */
	private String nombre = "Korby Fresa";
	private String transformacion = "Korby absorbe a un sujeto que lleva paraguas en la noche para no quemarse. "
			+ "\nKorby ahora lleva un paraguas.";
	private int vida = 18;
	private int golpe = 1;
	private int patada = 1;
	private int bloqueo = 1;
	private String especial = "Korby manda a llamar a sus guaruras:"
			+ "\n* golpe + 2 \n* patada + 2 \n* bloqueo + 2";
